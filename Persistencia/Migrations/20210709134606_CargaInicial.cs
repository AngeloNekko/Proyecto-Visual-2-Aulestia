        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeriodoVigentePeriodoId = table.Column<int>(type: "integer", nullable: true),
                    PeriodoVigenteIdPeriodoId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_configuracions_periodos_PeriodoVigenteIdPeriodoId",
                        column: x => x.PeriodoVigenteIdPeriodoId,
                        principalTable: "periodos",
                        principalColumn: "PeriodoId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_configuracions_periodos_PeriodoVigentePeriodoId",
                        column: x => x.PeriodoVigentePeriodoId,
                        principalTable: "periodos",
                        principalColumn: "PeriodoId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_configuracions_PeriodoVigenteIdPeriodoId",
                table: "configuracions",
                column: "PeriodoVigenteIdPeriodoId");

            migrationBuilder.CreateIndex(
                name: "IX_configuracions_PeriodoVigentePeriodoId",
                table: "configuracions",
                column: "PeriodoVigentePeriodoId");
